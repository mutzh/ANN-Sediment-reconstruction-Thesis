...
function [minObjective,bestNet]= bayes_opt_FF_det(data_NarxN)
...
objective_function=create_opti_bayes_FF_det(data_NarxN);%erstellen des function handle
...
results=bayesopt(objective_function,[Neurons_one,Neurons_two,tf1,tf2,tf3],'IsObjectiveDeterministic',true,'Verbose',0,...
                'MaxObjectiveEvaluations',15,'PlotFcn',plot_functions,'NumSeedPoints',4,'AcquisitionFunctionName',...
