function [func_bayesopt]=create_opti_bayes_FF_2D(data_NarxN) %außere funktion die die daten reinlädt und ein function handle aus der inneren erstellt
