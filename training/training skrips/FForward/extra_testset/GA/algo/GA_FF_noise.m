...
function [fval,aa]= GA_FF_noise(data_NarxN)
...
ga_opts=optimoptions('ga','Populationsize',40,'MaxGenerations',1000, 'Display','iter','PlotFcn',plots, 'maxTime',150,'EliteCount',3);
...
opti_func = GA_objective_FF_noise(data_NarxN);  %GA() erwartet ein function handle, dies fkt. erstellt eines aus der objective function
