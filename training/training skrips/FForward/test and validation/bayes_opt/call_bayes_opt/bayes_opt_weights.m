...
Neurons_one=optimizableVariable('NEURONS1',[2,13],'Type','integer');
Neurons_two=optimizableVariable('NEURONS2',[2,13],'Type','integer');
...
results=bayesopt(objective_function,[Neurons_one,Neurons_two,tf1,tf2,tf3],'IsObjectiveDeterministic',true,'Verbose',2,...
                'MaxObjectiveEvaluations',300,'PlotFcn','all','NumSeedPoints',6,'AcquisitionFunctionName',...
                'expected-improvement-plus','ExplorationRatio',0.5,'GPActiveSetSize',500,'MaxTime',800);
