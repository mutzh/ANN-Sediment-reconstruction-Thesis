...
function [minObjective,bestNet]= bayes_opt_NARX_rng(data_NarxN)
...
Neurons_one=optimizableVariable('NEURONS1',[1,4],'Type','integer');
Neurons_two=optimizableVariable('NEURONS2',[1,4],'Type','integer');
...
results=bayesopt(objective_function,[Neurons_one,Neurons_two,tf1,tf2,tf3,id,fd,seed],'IsObjectiveDeterministic',true,'Verbose',0,...
                ...
                'expected-improvement-plus','ExplorationRatio',0.6,'GPActiveSetSize',800,'MaxTime',2400);
