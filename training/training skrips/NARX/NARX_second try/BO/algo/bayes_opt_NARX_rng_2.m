...
function [minObjective,bestNet]= bayes_opt_NARX_rng_2(data_NarxN)
...
Neurons_one=optimizableVariable('NEURONS1',[1,12],'Type','integer');
Neurons_two=optimizableVariable('NEURONS2',[1,12],'Type','integer');
tf1=optimizableVariable('TF1',[1,3],'Type','integer');
tf2=optimizableVariable('TF2',[1,3],'Type','integer');
tf3=optimizableVariable('TF3',[1,2],'Type','integer');
id=optimizableVariable('ID',[1,10],'Type','integer');
fd=optimizableVariable('FD',[1,10],'Type','integer');
seed=optimizableVariable('SEED',[1,30],'Type','integer');



objective_function=create_opti_bayes_NARX_rng(data_NarxN);%erstellen des function handle
...
results=bayesopt(objective_function,[Neurons_one,Neurons_two,tf1,tf2,tf3,id,fd,seed],'IsObjectiveDeterministic',true,'Verbose',0,...
                ...
                'expected-improvement-plus','ExplorationRatio',0.6,'GPActiveSetSize',800,'MaxTime',450);
